...
(function() {
  var Collection, IDBStore, IndexedDb, _, async, compileSort, processFind, utils;
    ...
    IndexedDb.prototype.removeCollection = function(name, success, error) {
      ...
      return this.store.query((function(_this) {
        return function(matches) {
          var keys;
          keys = _.pluck(matches, function(m) {
  ...
  Collection = (function() {
    ...
    Collection.prototype.upsert = function(docs, bases, success, error) {
      ...
      keys = _.pluck(items, (function(_this) {
      ...
      return this.store.getBatch(keys, (function(_this) {
        return function(records) {
          var puts;
          puts = _.pluck(items, function(item, i) {
            var base;
            if (item.base !== void 0) {
              base = item.base;
    ...
    Collection.prototype.cache = function(docs, selector, options, success, error) {
      ...
      step2 = (function(_this) {
        return function() {
          ...
          return _this.find(selector, options).fetch(function(results) {
            var keys, removes;
            removes = [];
            keys = _.pluck(results, function(result) {
            ...
            return _this.store.getBatch(keys, function(records) {
              var i, j, record, ref, result;
              for (i = j = 0, ref = records.length; 0 <= ref ? j < ref : j > ref; i = 0 <= ref ? ++j : --j) {
                record = records[i];
                result = results[i];
      ...
      keys = _.pluck(docs, (function(_this) {
        return function(doc) {
    ...
    Collection.prototype.pendingUpserts = function(success, error) {
      return this.store.query(function(matches) {
        var upserts;
        upserts = _.pluck(matches, function(m) {
          return {
            doc: m.doc,
            base: m.base || null
          };
    ...
    Collection.prototype.resolveUpserts = function(upserts, success, error) {
      var keys;
      keys = _.pluck(upserts, (function(_this) {
      ...
      return this.store.getBatch(keys, (function(_this) {
        return function(records) {
          var i, j, puts, record, ref;
          puts = [];
          for (i = j = 0, ref = upserts.length; 0 <= ref ? j < ref : j > ref; i = 0 <= ref ? ++j : --j) {
            record = records[i];
